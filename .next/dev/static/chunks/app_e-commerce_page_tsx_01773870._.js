...
"[project]/app/e-commerce/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ShopifyComparison() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ShopifyComparison.useEffect": ()=>{
            setIsVisible(true);
            // Smooth scroll for anchor links
            const smoothScroll = {
                "ShopifyComparison.useEffect.smoothScroll": ()=>{
                    document.querySelectorAll('a[href^="#"]').forEach({
                        "ShopifyComparison.useEffect.smoothScroll": (anchor)=>{
                            anchor.addEventListener('click', {
                                "ShopifyComparison.useEffect.smoothScroll": function(e) {
                                    e.preventDefault();
            ...
            const animateOnScroll = {
                "ShopifyComparison.useEffect.animateOnScroll": ()=>{
                    const observerOptions = {
                        threshold: 0.1,
                        rootMargin: '0px 0px -50px 0px'
                    };
                    const observer = new IntersectionObserver({
                        "ShopifyComparison.useEffect.animateOnScroll": (entries)=>{
                            entries.forEach({
                                "ShopifyComparison.useEffect.animateOnScroll": (entry)=>{
                    ...
                    }["ShopifyComparison.useEffect.animateOnScroll"], observerOptions);
                    document.querySelectorAll('.scroll-animate').forEach({
                        "ShopifyComparison.useEffect.animateOnScroll": (el)=>{
                            observer.observe(el);
                        }
                    }["ShopifyComparison.useEffect.animateOnScroll"]);
                }
            ...
            const animateBars = {
                "ShopifyComparison.useEffect.animateBars": ()=>{
                    const barObserver = new IntersectionObserver({
                        "ShopifyComparison.useEffect.animateBars": (entries)=>{
                            entries.forEach({
                                "ShopifyComparison.useEffect.animateBars": (entry)=>{
                                    if (entry.isIntersecting) {
                                        const bars = entry.target.querySelectorAll('.bar-fill');
                                        bars.forEach({
                                            "ShopifyComparison.useEffect.animateBars": (bar)=>{
                                                ...
                                                }["ShopifyComparison.useEffect.animateBars"], 100);
                                            }
                                        }["ShopifyComparison.useEffect.animateBars"]);
                                    }
                                }
                    ...
                    document.querySelectorAll('.chart-section, .bar-chart').forEach({
                        "ShopifyComparison.useEffect.animateBars": (el)=>{
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: marketShareData.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: useCase.features.map((feature, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ShopifyComparison, "dxnQ2uwrHaO4RnSotDewn4GHM60=");
_c = ShopifyComparison;
var _c;
__turbopack_context__.k.register(_c, "ShopifyComparison");
...
//# sourceMappingURL=app_e-commerce_page_tsx_01773870._.js.map