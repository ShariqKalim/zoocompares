...
//         const value = getFeatureValue(provider, feature.key);
//         return (
//           <td key={provider.id} className={`px-2 sm:px-4 py-4 text-center ${provider.rank === 1 ? 'bg-green-50/50' : ''}`}>
...
//                   DigiCompares
//                 </h1>
//                 <p className="text-xs text-gray-600 font-medium">2025 Hosting Reviews & Deals</p>
//               </div>
//             </div>
//             <div className="flex items-center gap-4">
//               <a href="#comparison" className="text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors hidden sm:block">
//                 Comparison
//               </a>
//               <a href="#performance" className="text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors hidden sm:block">
//                 Performance
//               </a>
//               <a href="#faq" className="text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors hidden sm:block">
//                 FAQ
//               </a>
//               <a 
//                 href="/coupons"
...
//                 <span className="bg-white/20 px-2 py-1 rounded-full text-xs">85% OFF</span>
//               </a>
...
//                   </div>
//                   <div>
//                     <h4 className="font-bold text-gray-900 text-base mb-1">Enterprise Security</h4>
//                     <p className="text-gray-700 text-sm">
...
//               <div className="text-center mb-6">
//                 <div className="text-4xl mb-3">🏆</div>
//                 <h3 className="text-xl font-bold text-gray-900 mb-1">Hostinger 2025</h3>
//                 <p className="text-gray-600 text-sm">Premium Web Hosting</p>
//               </div>
//               <div className="space-y-4">
//                 <div className="flex justify-between items-center p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
//                   <span className="font-semibold text-gray-900 text-sm">Starting Price</span>
//                   <div className="text-right">
//                     <span className="text-lg font-bold text-green-600">$1.99/mo</span>
//                     <div className="text-xs text-gray-600 line-through">$12.99/mo</div>
//                   </div>
//                 </div>
//                 <div className="flex justify-between items-center p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
//                   <span className="font-semibold text-gray-900 text-sm">Performance</span>
//                   <span className="text-lg font-bold text-blue-600">160ms</span>
//                 </div>
//                 <div className="flex justify-between items-center p-3 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200">
//                   <span className="font-semibold text-gray-900 text-sm">Uptime</span>
//                   <span className="text-lg font-bold text-purple-600">99.99%</span>
//                 </div>
//                 <div className="flex justify-between items-center p-3 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg border border-orange-200">
//                   <span className="font-semibold text-gray-900 text-sm">Support Rating</span>
//                   <span className="text-lg font-bold text-orange-600">4.9/5</span>
//                 </div>
//                 <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg p-3 text-white text-center shadow-lg">
//                   <p className="font-bold text-sm">$200+ Value Included Free</p>
//                   <p className="text-xs opacity-90">Domain, SSL, and Premium Features</p>
//                 </div>
//                 <div className="bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg p-3 text-white text-center shadow-lg border-2 border-purple-400">
//                   <p className="font-bold text-sm">🎫 Extra Savings Available!</p>
//                   <p className="text-xs opacity-90">Use coupon code for additional discount</p>
//                   <CouponButton size="small" className="mt-2 w-full bg-white text-purple-600 hover:bg-gray-100" />
//                 </div>
//               </div>
//             </div>
//           </div>
...
//           <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center">
//             <div className="bg-gradient-to-br from-green-500 to-emerald-600 text-white rounded-xl p-4 shadow-lg">
//               <div className="text-xl font-bold mb-1">160ms</div>
//               <div className="text-green-100 text-xs">Hostinger Response</div>
//             </div>
//             <div className="bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-xl p-4 shadow-lg">
//               <div className="text-xl font-bold mb-1">99.99%</div>
//               <div className="text-blue-100 text-xs">Hostinger Uptime</div>
//             </div>
//             <div className="bg-gradient-to-br from-purple-500 to-pink-600 text-white rounded-xl p-4 shadow-lg">
//               <div className="text-xl font-bold mb-1">4.9/5</div>
//               <div className="text-purple-100 text-xs">Support Rating</div>
//             </div>
//             <div className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white rounded-xl p-4 shadow-lg">
...
//                         {provider.rank === 1 && (
//                           <div className="mt-2">
//                             <CouponButton size="small" className="w-full" />
//                           </div>
//                         )}
//                       </td>
//                     ))}
...
//           {/* Coupon CTA after FAQ */}
//           <div className="mt-12 text-center">
//             <div className="bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl p-6 text-white shadow-lg border-2 border-purple-400">
//               <h3 className="text-xl font-bold mb-2">🎫 Exclusive 2025 Coupon Available!</h3>
...
//             <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
//               <div className="text-left">
//                 <h3 className="text-white font-bold text-xl mb-2">🚀 2025 Limited Time Offer!</h3>
//                 <p className="text-white/90 text-sm">
...
//             </div>
//             <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20">
//               <h4 className="font-bold text-white text-base mb-3">💰 2025 Pricing</h4>
//               <ul className="text-gray-300 space-y-2 text-sm">
//                 <li>• 85% Discount</li>
...
//             </div>
//             <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-4 text-white">
//               <h4 className="font-bold text-base mb-3">🚀 Special 2025 Deal</h4>
//               <div className="text-2xl font-bold mb-1">$1.99/mo</div>
...
//               <h4 className="font-semibold text-white mb-4 text-base">Quick Links</h4>
//               <ul className="space-y-2">
//                 <li><a href="#comparison" className="hover:text-white transition-colors text-sm">2025 Comparison</a></li>
//                 <li><a href="#performance" className="hover:text-white transition-colors text-sm">Performance</a></li>
//                 <li><a href="#faq" className="hover:text-white transition-colors text-sm">2025 FAQ</a></li>
//                 <li><a href="/coupons" className="hover:text-white transition-colors text-sm">🎫 2025 Coupons</a></li>
//               </ul>
//             </div>
//             <div>
//               <h4 className="font-semibold text-white mb-4 text-base">Top Hosting</h4>
//               <ul className="space-y-2">
//                 <li><a href={HOSTINGER_AFFILIATE} className="hover:text-white transition-colors text-sm">Hostinger</a></li>
//                 <li><a href={SITEGROUND_AFFILIATE} className="hover:text-white transition-colors text-sm">SiteGround</a></li>
//                 <li><a href={A2HOSTING_AFFILIATE} className="hover:text-white transition-colors text-sm">A2 Hosting</a></li>
//                 <li><a href={WPENGINE_AFFILIATE} className="hover:text-white transition-colors text-sm">WP Engine</a></li>
//               </ul>
//             </div>
//             <div>
//               <h4 className="font-semibold text-white mb-4 text-base">Legal</h4>
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                        href: "#comparison",
                                        className: "text-xs sm:text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors hidden md:block",
                                        children: "Comparison"
                                    }, void 0, false, {
                                        fileName: "[project]/app/web-hosting/page.tsx",
                                        lineNumber: 7737,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                        href: "#faq",
                                        className: "text-xs sm:text-sm font-semibold text-gray-700 hover:text-green-600 transition-colors hidden sm:block",
                                        children: "FAQ"
                                    }, void 0, false, {
                                        fileName: "[project]/app/web-hosting/page.tsx",
                                        lineNumber: 7743,
                                                        ...
                                                        hostingProviders.slice(0, visibleProviders).map((provider)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                                        ...
                                                                        target: "_blank",
                                                                        rel: "noopener noreferrer",
                                                                        className: `inline-block px-3 py-2 sm:px-4 sm:py-3 rounded-lg font-bold text-white transition-all duration-300 text-xs sm:text-sm ${provider.rank === 1 ? 'bg-gradient-to-r from-green-500 to-emerald-600 hover:shadow-xl hover:scale-105 shadow-lg' : 'bg-gray-600 hover:bg-gray-700'}`,
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                ...
                                                target: "_blank",
                                                rel: "noopener noreferrer",
                                                className: `w-full py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg font-bold text-center block transition-all duration-300 text-xs sm:text-sm ${provider.rank === 1 ? 'bg-gradient-to-r from-green-500 to-emerald-600 hover:shadow-xl hover:scale-105 text-white shadow-lg' : 'bg-gray-900 hover:bg-gray-800 text-white'}`,
                                                children: provider.rank === 1 ? '🚀 Get Hostinger' : `Visit ${provider.name}`
                                            }, void 0, false, {
                                                fileName: "[project]/app/web-hosting/page.tsx",
                                                lineNumber: 8144,
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                href: "#",
                                                className: "hover:text-white ml-1 sm:ml-2",
...
_s1(ProfessionalHostingComparison, "s49COFZRIRHPt4EJ3XgHllocpXw=");
_c6 = ProfessionalHostingComparison;
...
__turbopack_context__.k.register(_c5, "CouponButton");
__turbopack_context__.k.register(_c6, "ProfessionalHostingComparison");
