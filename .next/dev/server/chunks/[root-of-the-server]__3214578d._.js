...
"[project]/app/sitemap.tsx [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function sitemap() {
    return [
        ...
        {
            url: "https://digicompares.com/web-hosting",
            lastModified: new Date()
        },
        {
            url: "https://digicompares.com/vpn",
            lastModified: new Date()
        },
        {
            url: "https://digicompares.com/crm-tools",
            lastModified: new Date()
        },
        {
            url: "https://digicompares.com/seo-tools",
            lastModified: new Date()
        },
        {
            url: "https://digicompares.com/cloud-workspaces",
            lastModified: new Date()
        },
        {
            url: "https://digicompares.com/e-commerce",
            lastModified: new Date()
        },
        {
            url: "https://www.digicompares.com/grammarly-ai-assistant",
            lastModified: new Date()
        },
        {
            url: "https://digicompares.com/ai-tools",
            lastModified: new Date()
        }
    ];
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$sitemap$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/sitemap.tsx [app-route] (ecmascript)");
...
if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$sitemap$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] !== 'function') {
    throw new Error('Default export is missing in "./sitemap.tsx"');
}
async function GET() {
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$sitemap$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3214578d._.js.map